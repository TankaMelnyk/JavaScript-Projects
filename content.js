...
Content.prototype.changeContentSize = function() {
    ...
    this.collisionManager_.changeFieldSize(this.visualContentContainer_.clientHeight, this.visualContentContainer_.clientWidth, this.scoreManager_);     //(width, height);
}
//---------------------------------------------------------------------------------------